...
import { attendance as attendanceApi, shiftAssignments as shiftAssignmentsApi } from '@/src/lib/api/hr';
import type { AttendanceDayRow, AttendanceRules, PunchResult, RegularizationView, ShiftAssignmentView } from '@/src/lib/attendance/types';
import { todayIso } from '@/src/lib/attendance/format';
