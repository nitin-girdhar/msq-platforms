...
export async function create(data: CreateLeadStageOutcomeInput) {
  const stage = await stageRepo.getById(data.stage_id);
...
export async function update(id: string, data: UpdateLeadStageOutcomeInput) {
