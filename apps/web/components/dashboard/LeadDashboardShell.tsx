...
import { DownloadButton } from '@crm/ui';
...
export default function LeadDashboardShell({ actor, enabledModules = ['crm'] }: Props) {
  ...
  return (
    <div className="flex w-full flex-1 flex-col bg-[#F8FAFC] lg:min-h-0">
      ...
      <MyDayWidget actor={actor} enabledModules={enabledModules} />
