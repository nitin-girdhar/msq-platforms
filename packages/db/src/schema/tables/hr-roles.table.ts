...
// Per-product HR role catalog (own rank scale). Tenant-scoped lookup (RLS,
// db_scripts/22), seeded in db_scripts/17. Unique per (tenant_id, name), not
// globally. See docs/DB_model.md → hr.roles.
export const hrRolesTable = hrSchema.table('roles', {
