...
import { shiftAssignments as shiftAssignmentsApi, shifts as shiftsApi, hrEmployees } from '@/src/lib/api/hr';
import type { ShiftView } from '@/src/lib/attendance/types';
import type { EmployeeProfileView } from '@/src/lib/leave/types';
