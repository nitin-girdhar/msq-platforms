...
export type HrModule = 'leave' | 'attendance' | 'tasks';
...
// In-process cached for 60s per tenant to avoid a query on every request.
export function requireModule(module: HrModule) {
