...
export const updateAttendanceStatusSchema = createAttendanceStatusSchema.partial().extend({
...
export type CreateAttendanceStatusInput = z.infer<typeof createAttendanceStatusSchema>;
