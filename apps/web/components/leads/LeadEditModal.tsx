...
import TaskLeadSection from '@/components/tasks/TaskLeadSection';
...
export function LeadEditModal({
  ...
  // Current follow-up due time comes straight from the lead record (crm.marketing_leads.scheduled_at) —
  ...
  // it's assigned to — appends a fresh crm.lead_follow_ups row (append-only history), even if
    ...
    >
      <div className="my-auto w-full max-w-3xl rounded-2xl bg-white shadow-2xl">
        ...
        <div className="flex flex-col divide-y divide-[#F1F5F9]">
          ...
          <TaskLeadSection leadId={lead.lead_id} actor={actor} />
