...
import type { PunchResult } from '@/src/lib/attendance/types';
import type { AttendanceRules } from '@/src/lib/attendance/types';
import { describePunchError } from '@/src/lib/attendance/format';
